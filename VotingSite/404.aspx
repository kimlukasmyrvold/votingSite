<%@ Page Title="404 - Page not found" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="VotingSite._404" %>

<asp:Content ID="error404" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
		...
		<nav class="errorLinks" aria-label="Secondary navbar">
			...
			<a runat="server" href="~/About/">Om oss</a>
			<a runat="server" href="~/Kommuner/">Kommuner</a>
			<a runat="server" href="~/Partier/">Partier</a>
			<a runat="server" href="~/Statistikk/">Statistikk</a>
		</nav>
	</main>
</asp:Content>